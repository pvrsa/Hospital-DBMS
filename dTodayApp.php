...
<head>
    ...
    <body>
            ...
            <br>
            <br>
            <h2 align="center"> Your appointments today</h2>
            <table class="table table-striped table-bordered table-hover">

            <?php
            $date = date("Y-m-d");
            $que=mysqli_query($con,"select app_pat_id,app_date,app_type from Appointment where app_doc_id=$var and app_date='$date';");
